...
void ProgressivePhotonScene::initBox(InitialCameraData& camera_data)
{
	...
	camera_data = InitialCameraData(
		//make_float3( -0.12526f, -0.306863f, 2.0142f ), /// eye 左边黑线
		make_float3( -0.24178f, -0.133496f, 2.43055f ),
		//make_float3( -1.12526f, -0.306863f, 2.0142f ), /// eye
		make_float3( 0.0f, -0.05f, 0.25f ),      /// lookat	左边黑线
		//make_float3( -0.5f, -0.05f, 0.25f ),      /// lookat	右边黑线
...
//		if (m_print_timings) std::cerr << "Starting RT pass ... ";
	...
	std::cout << "Pass :" << m_frame_number << " cost :" << tend - tstart << std::endl;
}
...
int main( int argc, char** argv )
{
	...
	if (timeout < 0.0) timeout = 1800;
	if (use_log) freopen("log.txt", "a", stdout);
